...
textCiphering = Button(text="Text Cipher",padx = 16, pady = 8, command=windowForTextCipher)
textCiphering.place(relx=0.3,rely=0.5)

textCiphering = Button(text="Image Cipher",padx = 16, pady = 8, command=windowForImageCipher)
